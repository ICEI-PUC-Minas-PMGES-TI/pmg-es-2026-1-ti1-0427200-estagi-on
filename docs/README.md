...
![Kaban](images/Gerenciamento.png)

O processo de Design Thinking foi aplicado nas etapas iniciais do projeto, com foco na compreensão do problema e das necessidades dos usuários,foram realizadas atividades de empatia e definição do problema, buscando entender as dificuldades enfrentadas por estudantes e empresas no contexto de busca por estágios. Por fim, foram levantadas ideias de solução e estruturada uma proposta inicial.
